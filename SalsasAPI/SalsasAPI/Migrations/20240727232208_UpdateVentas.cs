        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venta_Usuario_IdUsuarioNavigationIdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idSolicitud = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    cantidadProduccion = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Solicitud__idPro__10566F31",
                        column: x => x.idProducto,
                        principalTable: "Producto",
                        principalColumn: "idProducto");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitudProduccion_idProducto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Venta_IdUsuarioNavigationIdUsuario",
                table: "Venta",
