...
namespace SalsasAPI.Migrations
{
    ...
    [Migration("20240728013454_UpdateVentass")]
    partial class UpdateVentass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SalsasAPI.Models.DetalleVentum", b =>
                {
                    ...
                    b.Property<int?>("MedidumIdMedida")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SalsasAPI.Models.DetalleVentum", b =>
                {
                    ...
                    b.HasOne("SalsasAPI.Models.Medidum", null)
                        .WithMany("DetalleVenta")
                        .HasForeignKey("MedidumIdMedida");
